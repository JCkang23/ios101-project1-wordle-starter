...
class BoardController: NSObject,
  ...
  func enter(_ string: String) {
    ...
    UIView.animate(withDuration: 0.1,
      ...
      /*    Change the scale of the cell by 1.05
                - Use the transform property of the cell
                - Use transform.scaledBy to modify the scale
                - This should feel familiar to lab 1
       */
  ...
  func deleteLastCharacter() {
    ...
    /*  Call the public methods on LetterCell.swift
            - call a method to clear tjhe letter in a given cell
            - call a method to set the style of the cell to 'initial'
     */
